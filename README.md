...
Next, we're going to ensure connectivity between the client and domain controller. Connect to Client-1 using RDP and ping DC-1's private ip address using ping -t <ip address>. This command executes a perpetual ping.
<p>
